...
See [the Code documentation](#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure](docs/navigation/main/external) for more details.
...
See [Customization](docs/customization) for more information.
...
See [Callouts](link docs/ui-components/callouts) for more information.
...
[^js-disabled]: <span>New (v0.6.0)</span>
